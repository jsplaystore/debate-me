...
export function debateSystemPrompt(params: {
  ...
  return [
    ...
    `2. Cite real examples, studies, historical events, or data whenever possible. Be concrete, not abstract.`,
    ...
    `4. Keep it tight: 3-6 sentences total. Sharp, not rambling.`,
